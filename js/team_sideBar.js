...
let data = [
...

  {
    ...
    img1: "https://ifh.cc/g/glggo5.jpg",
    img2: "https://ifh.cc/g/qmFOGO.jpg",
    img3: "https://ifh.cc/g/L7Mpfz.jpg",
  },
...
$(document).ready(function () {
  $(".teamDiv").click(function () {
    ...
    $("#flick-img1").css({
      "background-image": `url('${data[i].img1}')`,
      "background-size": "384px 200px",
      "background-repeat": "no-repeat",
    });
    $("#flick-img2").css({
      "background-image": `url('${data[i].img2}')`,
      "background-size": "384px 200px",
      "background-repeat": "no-repeat",
    });
    $("#flick-img3").css({
      "background-image": `url('${data[i].img3}')`,
      "background-size": "384px 200px",
      "background-repeat": "no-repeat",
    });
